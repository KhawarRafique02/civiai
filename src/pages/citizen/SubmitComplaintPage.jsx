  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#f0fdf4", padding: "2rem" }}>
      ...
      <div style={{ background: "white", padding: "1rem 2rem", borderRadius: "12px", display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "2rem", boxShadow: "0 2px 10px rgba(0,0,0,0.08)" }}>
        ...
        <button onClick={() => navigate("/dashboard")} style={{ backgroundColor: "#f3f4f6", color: "#374151", border: "none", padding: "8px 16px", borderRadius: "8px", cursor: "pointer", fontWeight: "600" }}>
          ← Back
        </button>
      </div>

      {/* Form */}
      <div style={{ background: "white", padding: "2rem", borderRadius: "16px", maxWidth: "600px", margin: "0 auto", boxShadow: "0 2px 10px rgba(0,0,0,0.08)" }}>
          ...
          <div style={{ marginBottom: "24px" }}>
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              ...
              <button
                type="button"
                onClick={getLocation}
                style={{ backgroundColor: "#eff6ff", color: "#1d4ed8", border: "1px solid #bfdbfe", padding: "10px 16px", borderRadius: "8px", cursor: "pointer", fontWeight: "600", whiteSpace: "nowrap" }}
              >
                📍 Get Location
              </button>
            </div>
